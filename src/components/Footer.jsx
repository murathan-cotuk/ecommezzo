        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Ecommezzo, modern e-ticaret çözümleri sunarak işletmelerin büyümesine katkıda bulunur.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/webdesign" className="text-gray-400 hover:text-white">Webdesign</a></li>
                <li><a href="/marketing" className="text-gray-400 hover:text-white">Marketing</a></li>
            ...
            <div>
              ...
              <ul className="text-gray-400 space-y-2">
                <li>E-Mail: <a href="mailto:info@ecommezzo.com" className="hover:text-white">service@ecommezzo.com</a></li>
                <li>Telefon: <a href="tel:+901234567890" className="hover:text-white">+491604632233</a></li>
                <li>Adresse: Almastraße 73, 45886 Gelsenkirchen</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400 text-center md:text-right">
              &copy; {new Date().getFullYear()} Ecommezzo. Tüm hakları saklıdır.
            </div>
          </div>
        </div>
      </footer>
