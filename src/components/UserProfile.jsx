  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="flex items-center space-x-3 bg-white rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300"
      >
        <div className="w-8 h-8 bg-gradient-to-r from-#8f1818 to-wine-500 rounded-full flex items-center justify-center">
                ...
                <Link
                  ...
                  className={`flex items-center px-4 py-3 text-sm transition-colors duration-200 ${
                    item.danger
                      ...
                      : 'text-gray-700 hover:bg-#8f1818/10 hover:text-#8f1818'
                  }`}
