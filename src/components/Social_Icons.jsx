  ...
  return (
    <StyledWrapper>
      <div className="Social_Icons">
        <a href="https://www.instagram.com/ecommezzo/" className="socialContainer containerOne">
        ...
        <a href="https://tr.linkedin.com/company/ecommezzo" className="socialContainer containerThree">
