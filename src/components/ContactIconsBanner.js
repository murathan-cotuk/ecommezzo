        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <motion.div
              ...
              className={`w-32 h-32 md:w-48 md:h-48 mx-auto mb-4 md:mb-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-2xl ${currentItem.iconColor}`}
            >
              {currentItem.icon}
            </motion.div>
