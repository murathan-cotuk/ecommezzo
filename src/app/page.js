  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="w-1/2 pl-10 z-10 pb-40 pl-40 pt-20"> {/* Metin önde kalması için `z-10` ekledik */}
        ...
        Keine Lust mehr auf E-Commerce-Agenturen und Coaches, die nicht halten, was sie versprechen? Wir sind die Shopify Experts an deiner Seite. Dein Partner auf Augenhöhe – in guten wie in schlechten Zeiten.
        </p>
        <a href="/datenschutz"><button className="px-6 py-5 border-2 border-teal-400 bg-teal-500 text-cyan-950 hover:bg-teal-600 hover:text-cyan-950 transition-all duration-00 rounded-md font-bold mr-5">
              Shopaufbau
            </button>
            </a>
